//easy for removing and then inserting - 2
// for only inserting - 1
class Solution {
   public:
    ...
    int minOperations(string str1, string str2) {
        ...
        int lcs = solve(str1, str2, 0, 0, dp);
        //inserting & removing= m-lcs
        //only inserting = difference = (n-lcs)-(m-lcs))
        return ((m- lcs) * 2 + ((n-lcs)-(m-lcs)));
    }
};